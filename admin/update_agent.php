...
if(isset($_GET["id"])){
	$id = $_GET['id'];
	$query = mysqli_query($conn, "SELECT * FROM agents WHERE id = '$id'");
							...
							<div class="card card-custom">
								...
								<form id="update_agent">
											...
											<div class="row">
												<div class="col-md-12">
													<div class="form-group">
														...
														<input type="text" name="first_name" value="<?php echo $data['first_name']?>" class="form-control"
												...
												<div class="col-md-12">
													<div class="form-group">
														...
														<input type="text" name="last_name" value="<?php echo $data['last_name']?>" class="form-control"
									...
									<div class="card-footer">
										<button type="submit" class="btn btn-primary mr-2">Update Agent</button>
									</div>
								</form>
								<!--end::Form-->
							</div>
                    ...
                    success: function (val) {
                        ...
                        if (val == "0") {
                            ...
                            location.reload();
                                ...
                                setTimeout(function () {
                                    location.replace('view_agent.php');
                                }, 500);
