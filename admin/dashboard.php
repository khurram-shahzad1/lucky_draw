											...
											<?php 
												...
												<td><?php echo $s++?></td>
													...
													<td><?php 
															...
															if($status == 0){
															?>
															<button class="fas fa-check bg-success text-white acceptOrder" oid="<?php echo $data['id']; ?>"></button>
															<button class="fas fa-times bg-danger text-white rejectOrder" oid="<?php echo $data['id']; ?>"></button>
															<?php }
															elseif($status == 1){ ?>
															Paid
															<?php }
