...
<body id="kt_body"
						...
						<div class="container">
							<div class="card card-custom">
								...
								<form id="add_draw">
									...
									<input type="hidden" name="add_draw" value="1">
									<div class="card-footer">
										<button type="submit" class="btn btn-primary mr-2">Add Draw</button>
									</div>
								</form>
								<!--end::Form-->
							</div>
	...
	<script>
	$(function () {
            $('#add_draw').on('submit', function (e) {
                e.preventDefault();
                $.ajax({
                    type: 'post',
                    url: 'core/actions.php',
                    data: $('#add_draw').serialize(),
                    success: function (val) {
                        ...
                        if (val == "0") {
                            ...
                            location.reload();
                                ...
                                setTimeout(function () {
                                    location.replace('view_draw.php');
                                }, 500);
