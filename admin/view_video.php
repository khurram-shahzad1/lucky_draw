...
<body id="kt_body"
								...
								<div class="card card-custom">
									<div class="card-header">
										<div class="card-title">
											...
											<h3 class="card-label">View Video</h3>
										</div>
									</div>
										...
										<table class="table  w-100 mx-auto table-bordered table-hover table-checkable dataTable no-footer dtr-inline" id="result" style="margin-top: 13px !important;" role="grid" aria-describedby="kt_datatable_info">
											...
											<?php 
														...
														<tr>
															...
															<td><button class="fas fa-trash-alt bg-danger text-white delvideoid" delvideoid="<?php echo $data['id']?>"></button>
															</td>
														</tr>
														<?php }?></tbody>
										</table></div></div>
	...
	<script>
		...
		$(function () {
        $('.delvideoid').on('click', function (e) {
            e.preventDefault();
            var id = $(this).attr("delvideoid");
            $.ajax({
