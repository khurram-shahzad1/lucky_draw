									...
									<div class="card card-custom card-stretch gutter-b">
										...
										<div class="card-header border-0 py-5">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label font-weight-bolder text-dark">View Draw</span>
											</h3>
										</div>
										<!--end::Header-->
										<!--begin::Body-->
												...
												<table class="table" id="table">
													<thead>
														<tr>
															...
															<th scope="col">Add Winner</th>
														</tr>
													</thead>
													<tbody>
														<?php 
														$query = mysqli_query($conn, "SELECT * FROM draw");
														$s=1;
														...
														<tr>
															...
															<td><a href="update_draw.php?id=<?php echo $data['id']?>"><button class="btn btn-primary btn-sm text-white">Add Winner</button></a></td>
														</tr>
														<?php }
														?>
